...
function LoginForm({ providers }: { providers: { google: boolean; github: boolean } }) {
  const params = useSearchParams();
  // Default to the landing page so users land there first after sign-in.
...
export function LoginFormSection({ providers }: { providers: { google: boolean; github: boolean } }) {
  return (
    <Suspense>
...
function Field({ label, name, type = "text", placeholder, icon, autoComplete, required, error, defaultValue, trailing }: FieldProps) {
  return (
